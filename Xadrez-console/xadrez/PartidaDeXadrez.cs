...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        {
            Peca pecaCaputurada = executaMovimento(origem, destino);
        ...
        {
            //se a peça de origem não pode mover para a posição de destino...
        ...
        //método para testar todas as opções de matrizes
